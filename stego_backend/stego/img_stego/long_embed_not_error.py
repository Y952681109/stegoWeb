...
secret_to_encode = "hello this is 1a秘密信息, 这是一个长文本测试,test,test,，hello。世界,再加两个字符试一下"
input_image_path = "examples/cover6.jpg"
output_image_path = "long_embed_image.jpg"
